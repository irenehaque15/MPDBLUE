...
function s3_swf_init(id, options)
{
	...
	s3_upload_swfobject.embedSWF("/flash/s3_upload.swf", id, buttonWidth, buttonHeight, flashVersion, false, flashvars, params, attributes);
